...
/* Create the function pointer to the application address */
/* USER CODE END PTD */

/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */

/* Define the application address */
/* USER CODE END PD */
...
int main(void)
{
  ...
  /* USER CODE BEGIN 1 */
	...
	BootloaderSharedAPI* api = (BootloaderSharedAPI*) API_ADDRESS;
  /* USER CODE END 1 */
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  // Apply the function call //
		printf("This is inside APP loop\r\n");
		api -> Blink(200);
		HAL_Delay(1000);
  }
  /* USER CODE END 3 */
...
void SystemClock_Config(void)
{
  ...
  __HAL_RCC_PWR_CLK_ENABLE();  // <<== ADD THIS LINE
